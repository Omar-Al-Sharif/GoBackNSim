...
TransmittedMsg::TransmittedMsg(const char *name, short kind) : ::omnetpp::cPacket(name,kind)
{
    this->parity = 0;
    this->seqNumber = 0;
    this->frameType = 0;
...
TransmittedMsg::TransmittedMsg(const TransmittedMsg& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
TransmittedMsg& TransmittedMsg::operator=(const TransmittedMsg& other)
{
...
void TransmittedMsg::copy(const TransmittedMsg& other)
{
...
void TransmittedMsg::parsimPack(omnetpp::cCommBuffer *b) const
{
...
void TransmittedMsg::parsimUnpack(omnetpp::cCommBuffer *b)
{
...
int TransmittedMsg::getParity() const
{
    return this->parity;
}

void TransmittedMsg::setParity(int parity)
{
    this->parity = parity;
}

int TransmittedMsg::getSeqNumber() const
{
    return this->seqNumber;
}

void TransmittedMsg::setSeqNumber(int seqNumber)
{
    this->seqNumber = seqNumber;
}

const char * TransmittedMsg::getPayload() const
{
    return this->payload.c_str();
}

void TransmittedMsg::setPayload(const char * payload)
{
    this->payload = payload;
}

int TransmittedMsg::getFrameType() const
{
    return this->frameType;
}

void TransmittedMsg::setFrameType(int frameType)
{
    this->frameType = frameType;
}

int TransmittedMsg::getAckNumber() const
{
    return this->ackNumber;
}

void TransmittedMsg::setAckNumber(int ackNumber)
{
...
{
    return dynamic_cast<TransmittedMsg *>(obj)!=nullptr;
}
...
int TransmittedMsgDescriptor::getFieldArraySize(void *object, int field) const
{
    ...
    TransmittedMsg *pp = (TransmittedMsg *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}
